...
const captions = [
  ...
  "It's difficult to enter into this work because of how the metaphorical resonance of the subject verges on codifying the accessibility of the work. ",
  ...
  "I find this work menacing/playful because of the way the iconicity of the figurative-narrative line-space matrix endangers the devious simplicity of the remarkable handling of light. ",
